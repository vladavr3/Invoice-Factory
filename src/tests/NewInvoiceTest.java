...
public class NewInvoiceTest extends Browser{
	...
	NewInvoice invoice;
	 ...
	 @Test(priority=24)
	    public void cancelAll() {
		 invoice = new NewInvoice(driver);
		 invoice.dropChanges();
		 assertTrue(invoice.noInvoicesCheck());
		}
	 
	 @Test(priority=25)
	 public void newInvoice2() throws InterruptedException {
		 invoice = new NewInvoice(driver);
		 Thread.sleep(2000);
		 invoice.addInvoice();
		 assertTrue(invoice.saveButton());
	...
	/* @Test(priority=41)
	    public void hours() {
		 invoice = new NewInvoice(driver); // iskomentarisan je unos broja sati
		 invoice.hoursInput;
		}*/
